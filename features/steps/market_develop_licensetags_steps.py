...
@then('Verify {expected_amount} tags are shown page2')
...
@then('Verify {expected_amount} tags are shown page3')
...
@then('Verify {expected_amount} tags are shown page4')
...
@then('Verify {expected_amount} tags are shown page5')
...
@then('Verify {expected_amount} tags are shown page6')
...
@then('Verify {expected_amount} tags are shown page7')
